...
public class Konzola {
     ...
     *          ili je prazna
     * @throws  NoSuchElementException Ako se program prekine dok se �?eka na unos
     * 
     */
     ...
     * odri�?an odgovor na pitanje. Unos se ponavlja sve dok se ne unese jedan
     ...
     * @param      ne  Ponuđeni {@code String} rezervisan za odri�?an odgovor
    ...
    /**
     * Zahteva od korisnika unos {@code String}-a koji mora biti jednak
     * "d" ili "n" za potvrdan, odnosno odri�?an odgovor. Unos se ponavlja sve
